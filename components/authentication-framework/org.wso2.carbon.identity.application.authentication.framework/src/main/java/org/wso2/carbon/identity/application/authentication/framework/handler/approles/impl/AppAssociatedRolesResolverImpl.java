...
public class AppAssociatedRolesResolverImpl implements ApplicationRolesResolver {
    ...
    private Set<String> getAllRolesOfFederatedUser(AuthenticatedUser authenticatedUser)
        ...
        List<String> userIdPGroups = getFederatedUserIDPGroups(authenticatedUser, identityProvider);
        if (CollectionUtils.isEmpty(userIdPGroups)) {
            return Collections.emptySet();
        }
        List<String> userIdPGroupIdList = getUserIdPGroupIdList(userIdPGroups, idpGroups);
        List<String> roleIdsFromIDPGroups = getRoleIdsOfIdpGroups(userIdPGroupIdList, tenantDomain);
     ...
     */
    private List<String> getUserIdPGroupIdList(List<String> userIdPGroups, IdPGroup[] idpGroups) {
     ...
     */
    private List<String> getFederatedUserIDPGroups(AuthenticatedUser authenticatedUser, IdentityProvider federatedIdP) {
